package com.yq.demo.fragmentviewpage;
...
import com.yq.demo.utils.Contents;
...
public class MyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (key == null || key.equals(Contents.ZH)) {
            view = inflater.inflate(R.layout.fragment_lay1, container, false);
        ...
        if (key != null && key.equals(Contents.XW)) {
            view = inflater.inflate(R.layout.fragment_lay2, container, false);
        ...
        if (key != null && key.equals(Contents.YL)) {
            view = inflater.inflate(R.layout.fragment_lay3, container, false);
        }

        if (key != null && key.equals(Contents.TY)) {
            view = inflater.inflate(R.layout.fragment_lay4, container, false);
