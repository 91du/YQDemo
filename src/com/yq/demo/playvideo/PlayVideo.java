 ...
 * 
 *         RTSP：Real Time Streaming Protocal，实时流媒体传输控制协议。 使用RTSP时，流媒体的格式需要是RTP。
...
public class PlayVideo extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.activity_playvideo);

        Uri uri = Uri.parse("http://mapps.m1905.com/yxl.mp4");
        VideoView videoView = (VideoView) this.findViewById(R.id.playvideo_videoview);
